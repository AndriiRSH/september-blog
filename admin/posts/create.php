...
<div class="container">
    ...
    <div class="posts col-9">
        <div class="button row">
            <a href="admin/posts/create.php" class="col-2 btn btn-success">Створити</a>
            <span class="col-1"></span>
            <a href="index.php" class="col-3 btn btn-warning">Редактувати</a>
        </div>
        ...
        <div class="row add-post">
            ...
            <form action="create.php" method="post" enctype="multipart/form-data">
                ...
                <div class="col col-6">
                    <button name="add_post" class="btn btn-primary" type="submit">Додавання допису</button>
                </div>
            </form>
        </div>
